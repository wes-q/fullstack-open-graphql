...
const resolvers = {
    Query: {
        ...
        allBooks: (root, args) => {
            // // ## This works the same with below
            // const filteredBooks = books.filter(({ author, genres }) => {
            //     const authorMatch = args.author ? author === args.author : true;
            //     const genreMatch = args.genre ? genres.includes(args.genre) : true;
